...
class AuthController{
  ...
  void signUp(BuildContext context,String name,String deviceId,String password,){
    _authRepository.signUpUser(context: context,name: name,deviceId: deviceId ,password: password, );
  }
